...
#
# Usage: ./ssh.sh <gpu-qwen3-30b|gpu-rtx4000|gpu-rtx4000-llama3|cpu-qwen3-30b>
set -euo pipefail

if [[ $# -ne 1 ]]; then
  echo "Usage: $0 <gpu-qwen3-30b|gpu-rtx4000|gpu-rtx4000-llama3|cpu-qwen3-30b>" >&2
  exit 1
fi
...
if [[ ! -d "$module_dir" ]]; then
  echo "No such module: '${module}' (expected one of: gpu-qwen3-30b, gpu-rtx4000, gpu-rtx4000-llama3, cpu-qwen3-30b)" >&2
  exit 1
fi
